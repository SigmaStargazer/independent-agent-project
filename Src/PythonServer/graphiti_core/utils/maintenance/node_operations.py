...
async def extract_nodes(
    ...
    while entities_missed and reflexion_iterations <= MAX_REFLEXION_ITERATIONS:
        ...
        # print("DEBUG - llm_response:", llm_response) # 测试
...
async def resolve_extracted_nodes(
    ...
    # print("LLM Response:", llm_response) # 调试
    # 把duplicates的值改成[]
    for item in llm_response.get("entity_resolutions", []):
        if item.get("duplicates") is None:
            item["duplicates"] = []
    ...
    for resolution in node_resolutions:
        ...
        duplicates: list[int] = resolution.duplicates or []
