    ...
    public class SceneObjInfoRenderer
    {
        ...
        public string RenderSceneObj(SceneObjInfoModel sceneObjInfo)
        {
            ...
            if (sceneObjInfo != null)
            {
                ...
                string faceDirectionStr = !string.IsNullOrEmpty(sceneObjInfo.FaceDirection) ? $"朝向:{sceneObjInfo.FaceDirection}\n" : "";
                // 方位
                string directionStr;
                ...
                {
                    directionStr = $"方位:在你的 {sceneObjInfo.Direction}方向 {sceneObjInfo.Distance:F2}m 位置";
                }
